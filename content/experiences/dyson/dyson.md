...
{{< figure src="/images/experiences/dyson/dyson_devices.png" alt="Dyson devices" class="tc" >}}
...
A few of the open-source projects I contributed to while at Dyson include:

- [Universal Robot](https://github.com/dysonltd/universal-robot): A Rust library for interfacing with Universal Robots robotic arms over TCP/IP. Hats off to [James Sizeland](https://www.linkedin.com/in/james-sizeland-02530256/) for leading this effort and creating a very cool library.

- [Commitment Issues](https://github.com/dysonltd/commitment-issues): A Rust library that allows compiling the metadata of Git commits into your binary at build time. This is super useful for tracking firmware versions in embedded systems. Hats off to [Pete Kubiak](https://www.linkedin.com/in/pete-kubiak-9252a3216/) for spearheading this project.
...
- [TMAG5273 Driver](https://github.com/scottgibb/tmag5273): A Rust driver for the TMAG5273 magnetic sensor, A truly cross platform driver supporting systems such as MacOS, Linux, Raspberry Pi, ESP32 and STM32. Our first Rust project in Landrace.
