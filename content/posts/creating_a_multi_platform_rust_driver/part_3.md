...
- STM32 devices using [STM32F072](https://www.digikey.co.uk/en/products/detail/stmicroelectronics/NUCLEO-F072RB/5047984) with the `embassy-stm32` HAL using `sync` code
- [PiPico](https://thepihut.com/products/raspberry-pi-pico) devices using the RP2040 with the `PiPico` HAL using `sync` code
- ESP32 devices using the [ESP32C3](https://thepihut.com/products/seeed-xiao-esp32c3) with the `ESP-HAL` using  `sync` code
